...
__all__ = [
    ...
    "place_source_at_bottom", "set_source_prompt_extra", "get_silent_sources", "get_sources_of_type", "get_paused_sources", "reorder_source",
    "get_source_health",
    ...
    "prune_old_items", "set_item_embeddings", "mark_duplicate", "get_recent_embedded_items", "discard_unsent_items",
